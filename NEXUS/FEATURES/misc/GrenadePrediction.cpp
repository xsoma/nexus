		...
		if ((type) && path.size() > 1)
		{
			...
			if (RENDER::WorldToScreen(prev, nadeEnd))
			{
				if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_FLASHBANG)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "Flash");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_HEGRENADE)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "HE");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_INCGRENADE)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "Inc");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_MOLOTOV)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "Molotov");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_DECOY)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "Decoy");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_SMOKEGRENADE)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "Smoke");
			}
		}
	}
}
