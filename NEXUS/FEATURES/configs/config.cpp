...
void c_config::setup()
{
	...
	SetupValue(SETTINGS::settings.hitboxes, 0, ("aimbot"), ("hitboxes"));

	SetupValue(SETTINGS::settings.auto_hitchance, 0, ("aimbot"), ("auto hitchance"));
	SetupValue(SETTINGS::settings.auto_mindamage, 1, ("aimbot"), ("auto min damage"));

	SetupValue(SETTINGS::settings.scout_hitchance, 0, ("aimbot"), ("scout hitchance"));
	SetupValue(SETTINGS::settings.scout_mindamage, 1, ("aimbot"), ("scout min damage"));

	SetupValue(SETTINGS::settings.awp_hitchance, 0, ("aimbot"), ("awp hitchance"));
	SetupValue(SETTINGS::settings.awp_mindamage, 1, ("aimbot"), ("awp min damage"));

	SetupValue(SETTINGS::settings.heavy_pistol_hitchance, 0, ("aimbot"), ("heavy pistols hitchance"));
	SetupValue(SETTINGS::settings.heavy_pistol_mindamage, 1, ("aimbot"), ("heavy pistols min damage"));

	SetupValue(SETTINGS::settings.pistol_hitchance, 0, ("aimbot"), ("pistols hitchance"));
	SetupValue(SETTINGS::settings.pistol_mindamage, 1, ("aimbot"), ("pistols min damage"));

	SetupValue(SETTINGS::settings.rifle_hitchance, 0, ("aimbot"), ("rifles hitchance"));
	SetupValue(SETTINGS::settings.rifle_mindamage, 1, ("aimbot"), ("rifles min damage"));

	SetupValue(SETTINGS::settings.other_hitchance, 0, ("aimbot"), ("other hitchance"));
	SetupValue(SETTINGS::settings.other_mindamage, 1, ("aimbot"), ("other min damage"));
	...
	SetupValue(SETTINGS::settings.fake_bool, false, ("aimbot"), ("fake-lag prediction"));
	...
	SetupValue(SETTINGS::settings.resolver, false, ("aimbot"), ("resolver"));
	...
	SetupValue(SETTINGS::settings.desync_color[0], 1.f, ("visuals"), ("desync_color_r"));
	SetupValue(SETTINGS::settings.desync_color[1], 0.f, ("visuals"), ("desync_color_g"));
	SetupValue(SETTINGS::settings.desync_color[2], 0.f, ("visuals"), ("desync_color_b"));
...
void c_config::Save()
{
	...
	{
		char szCmd[256];
		sprintf(szCmd, "\\Nexus\\%s.cfg", SETTINGS::settings.config_name);
